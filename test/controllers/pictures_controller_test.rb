...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { Post_id: @picture.Post_id, image: @picture.image } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { Post_id: @picture.Post_id, image: @picture.image } }
